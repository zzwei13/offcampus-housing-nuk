...
if($row['Review'] == 'valid'){
  ...
  <div class="card h-100"><img class="card-img-top w-100" style="height: 200px; object-fit: cover" src="data:image/jpeg;base64,' . base64_encode($row['first_image']) . '">
    <div class="card-body">
      <h5 class="font-sans-serif fw-bold fs-md-0 fs-lg-1">' . $row['RentTitle'] . '</h5><a class="text-muted fs--1 stretched-link text-decoration-none" href="ad_delete.php?info_id=' . $row['InformationID'] . '">' . $row['Address'] . '</a>
    </div>
  </div>
</div>';
}
