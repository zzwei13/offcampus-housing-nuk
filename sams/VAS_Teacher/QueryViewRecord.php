                    ...
                    <div class="row center-section">
                        ...
                        <div class="col-md-9 col-lg-12 text-md-start text-center py-4">           
                            ...
                            <form id="toUpdateForm" action="QueryViewRecord.php" method="get">
                                ...
                                <button type="submit" formaction="RecordList.php" formmethod="get" class="btn btn-secondary"><</button>
                                <button type="submit" formaction="UpdateRecord.php" formmethod="get" class="btn btn-primary">修改紀錄</button><!--進入修改訪視紀錄表單-->
