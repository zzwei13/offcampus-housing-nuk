              ...
              <div class="row">
                <div class="col-md-15 mb-2"> <!-- 調整 mb-2 可以增加或減少距離 -->
                  <div class="card h-100">
                    <div class="card-body">
                      <h5 class="card-title mb-0">填寫住宿資料表單</h5>
                      <a href="house_information.php" class="btn btn-primary mt-3">前往</a>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-15 mb-2"> <!-- 調整 mb-2 可以增加或減少距離 -->
                  <div class="card h-100">
                    <div class="card-body">
                      <h5 class="card-title mb-0">檢視住宿資料</h5>
                      <a href="house_choose.php" class="btn btn-primary mt-3">前往</a>
                    </div>
                  </div>
                </div>
