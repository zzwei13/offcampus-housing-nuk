...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  UNION ALL SELECT Username as 'Name' FROM accountmanagement WHERE (PermissionLevel = '管理員' && Username = '$inputUsername')
  UNION ALL SELECT d.Name FROM accountmanagement a INNER JOIN landlords d ON a.UserID = d.LandlordID WHERE a.Username = '$inputUsername'
  ";
  ...
  if ($result->num_rows > 0) {
    ...
    #如果是學生，導向到學生頁面
    else if($inputPermissionLevel == "學生" || $inputPermissionLevel == "導師")
