...
<body>
    ...
    <main class="main" id="top">
        ...
        <section class="pt-6 bg-600" id="home">
            <div class="container">
                <h1 class="fw-bold font-sans-serif">租屋資訊</h1>
                <br>
                ...
                <?php
                echo "<a class=\"btn btn-danger\" style=\"margin-right: 10px;\" href='rentInformationDelete.php?InformationID=" . $informationID . "'>刪除</a>";
                echo "<a class=\"btn btn-primary\" href='rentInformationEdit.php?InformationID=" . $informationID . "'>編輯</a>";
                ?>
            </div>
        </section>
