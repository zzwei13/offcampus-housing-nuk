      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-12 text-md-start text-center py-6">
            ...
            <div class="menu">
              <ul>
                <li class="item"><a href="user_list.php">查看用戶列表</a></li>
                <li class="item"><a href="add_user.php">新增用戶</a></li>
                <li class="item"><a href="edit_user.php">編輯用戶資料</a></li>
                <li class="item"><a href="delete_user.php">刪除用戶</a></li>
                <li class="item"><a href="reset_password.php">重置用戶密碼</a></li>
                <li class="item"><a href="set_permissions.php">用戶權限設置</a></li>
              </ul>
            </div>
          </div>
        </div>
