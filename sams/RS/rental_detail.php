...
session_start();
// 檢查是否已登入且用戶為房東
if (!isset($_SESSION['permissionLevel']) || $_SESSION['permissionLevel'] != '房東') {
    // 如果不是房東，則導向到主頁面或登入頁面
...
<body>
    ...
    <main class="main" id="top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light sticky-top py-3 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
            <div class="container">
              <a class="navbar-brand" href="landlordPage.php"><img src="static/picture/nuk.png" height="45" alt="logo"></a>
