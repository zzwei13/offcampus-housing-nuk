...
<head>
    ...
    <title>User Information | Responsive Template</title>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-auto d-none d-lg-block">
                        <p class="my-2 fs--1"><i class="fas fa-map-marker-alt me-3"></i>國立高雄大學</p>
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <tbody>
                            <?php switch ($permissionLevel):
                                case '學生': ?>
                                    ...
                                    <tr><td>家中地址</td><td><?= htmlspecialchars($userData['HomeAddress']) ?></td></tr>
                                    <tr><td>家裡電話</td><td><?= htmlspecialchars($userData['HomePhone']) ?></td></tr>
                                    <tr><td>家裡聯絡人</td><td><?= htmlspecialchars($userData['EmergencyContactName']) ?></td></tr>
                                    <tr><td>聯絡人電話</td><td><?= htmlspecialchars($userData['EmergencyContactPhone']) ?></td></tr>
                                    <?php break;
                                case '導師': ?>
                                    <tr><td>導師ID</td><td><?= htmlspecialchars($userData['TeacherID']) ?></td></tr>
                                    <tr><td>姓名</td><td><?= htmlspecialchars($userData['Name']) ?></td></tr>
                                    <tr><td>職級</td><td><?= htmlspecialchars($userData['Rank']) ?></td></tr>
                                    <tr><td>連絡電話</td><td><?= htmlspecialchars($userData['ContactPhone']) ?></td></tr>
                                    <tr><td>Email</td><td><?= htmlspecialchars($userData['T_Email']) ?></td></tr>
                                    <tr><td>辦公室位址</td><td><?= htmlspecialchars($userData['OfficeAddress']) ?></td></tr>
                                ...
                                case '房東': ?>
                                    ...
                                    <?php break;
                                default: ?>
                                    <tr><td colspan="2">未知的權限等級，請提供有效的權限等級。</td></tr>
                            <?php endswitch; ?>
                        </tbody>
                    </table>
                </div>
