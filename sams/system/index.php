...
<body>
  <?php
    ...
    $permissionLevel = isset($_SESSION['permissionLevel']) ? $_SESSION['permissionLevel'] : '';
  ?>

  <main class="main" id="top">
    <nav class="navbar navbar-expand-lg navbar-light sticky-top py-3 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container">
          <a class="navbar-brand"><img src="static/picture/nuk.png" height="45" alt="logo"></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
                  ...
                  <a class="nav-link active" aria-current="page" 
                     href="<?php 
                        if ($permissionLevel == '管理員') { 
                          echo 'management.php'; 
                        } elseif ($permissionLevel == '學生') { 
                          echo '../VAS_student/HouseInfoManage.php'; 
                        } elseif ($permissionLevel == '房東') { 
                          echo '../RS/landlordPage.php'; 
                        } 
                     ?>">功能頁</a>
                </li> 
              <?php endif; ?>
            ...
            <div id="userStatus" class="ms-lg-2">
              ...
              <?php else: ?>
                <a class="btn btn-primary" href="login.html" role="button">登入</a>
              <?php endif; ?>
            </div>
          </div>
        </div>
