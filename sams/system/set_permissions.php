...
<body>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-12 text-md-start text-center py-6">
            <h1 class="fw-bold font-sans-serif mb-5">修改用戶權限等級</h1>
            <form id="searchForm" class="d-flex justify-content-center" method="post" action="set_permissions.php">
                ...
                require 'connect.php';
                  ...
                  if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td><button onclick=\"resetpassword('" . $row['UserID'] . "')\">修改用戶權限等級</button></td></tr>";
                    }
                    echo "</tbody></table>";
                } else {
                    echo "<p>未找到相關用戶</p>";
  ...
  <script>
    function resetpassword(userID) {
      window.location.href = 'set_permissions_form.php?userID=' + userID;
    }
  </script>
