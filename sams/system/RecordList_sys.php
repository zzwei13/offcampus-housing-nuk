...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light sticky-top py-3 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
            <div class="container">
              <a class="navbar-brand" href="management.php"><img src="static/picture/nuk.png" height="45" alt="logo"></a>
        ...
        <section class="center-section bg-600">
            ...
            <form id="backForm" action="management.php" method="get" style="margin-right: 20px;">
                <button type="submit" form="backForm" class="btn btn-secondary"> < </button>
            </form>
            <form class="d-flex my-3 d-block custom-search" action="RecordList_sys.php" method="GET">
