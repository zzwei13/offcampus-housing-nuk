      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-12 text-md-start text-center py-6">
            <h1 class="fw-bold font-sans-serif mb-5">刪除用戶</h1>
            <form id="searchForm" class="d-flex justify-content-center" method="post" action="delete_user.php">
                ...
                require 'connect.php';
                  ...
                  if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td><button onclick='deleteuser(\"" . $row['UserID'] . "\")'>刪除用戶</button></td>";
...
function deleteuser(userID) {
  var confirmed = confirm('確定要刪除這個用戶嗎？');
  if (confirmed) {
