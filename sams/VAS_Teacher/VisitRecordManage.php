...
<body>
    <main class="main" id="top">
        ...
        <section class="pt-6 pb-6 bg-600">
            <div>
        ...
        <section class="center-section pt-6 bg-600">
            ...
            <div class="link-container">
                <a href="RecordList.php" class="btn btn-primary mt-3">查詢訪視紀錄</a>
            </div>
            <div class="link-container">
                <a href="CreateRecordList.php" class="btn btn-primary mt-3">新增訪視紀錄</a>
            </div>
